...
public class prueba2 extends JFrame implements ActionListener, FocusListener, KeyListener, MouseListener,ItemListener, ChangeListener{
...
//actualizar
{
	...
	{combo2 = new JComboBox<String>();
		combo2.setBounds(350,150,90,20);
		add(combo2);
...
if(accion.getSource() == bot){

	Connection cn = null;
	PreparedStatement pst = null;
	String AccionSQL = "UPDATE datos SET Nombre =?, Domicilio =?, Correo =?, Telefono =?, Dia=?, Hora=?,Tipo =? WHERE Nombre =? ";
	...
	try{
		...
		pst.setString(1, campoTexto.getText());
		pst.setString(2, campotex.getText());
		pst.setString(3, campoTexto2.getText());
		pst.setString(4, campoTexto3.getText());
		pst.setString(5, dia);
		pst.setString(6,hor);
		pst.setString(7,tipo);
		pst.setString(8, campoTexto4.getText());
		pst.executeUpdate();
	}
	catch(Exception e){
	...
	System.out.println("Algo salio mal1"+e.getMessage());
}
...
public static void main (String args[]){
		prueba2 formmulario = new prueba2();
