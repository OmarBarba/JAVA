...
public class prueba extends JFrame implements ActionListener, FocusListener, KeyListener, MouseListener,ItemListener,ChangeListener{
...
//accion
{
	...
	String AccionSQL = "INSERT INTO datos(Nombre,Domicilio,Correo,Telefono,Dia,Hora,Tipo) Values(?,?,?,?,?,?,?)";
